...
CREATE TABLE `BOOKMARKS` (
  ...
  `Contents` mediumtext CHARACTER SET utf16 COLLATE utf16_bin NOT NULL,
  `Search Dump` mediumtext CHARACTER SET utf16 COLLATE utf16_bin,
  PRIMARY KEY (`Timestamp`,`User ID`),
