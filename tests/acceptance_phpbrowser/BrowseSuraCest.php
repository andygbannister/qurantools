...
/**
 * Tests to ensure browse_root_usage.php works
 */
class BrowseSuraCest extends QTPageCest
{
    public function _before($I, $scenario)
    {
        $this->page_of_interest = $I->getApplicationPage("browse_sura");
    ...
    public function accessRulesWork(
        ...
        parent::accessRulesWork(
            $I,
            $scenario,
            "//h2[contains(text(),'List of All Suras')]"
        );
    }
}
