...
/**
 * Tests to ensure that browse_root_usage.php works
 */
class BrowseRootUsageCest extends QTPageCest
{
    public function _before($I, $scenario)
    {
        $this->page_of_interest = $I->getApplicationPage("browse_root_usage");
    ...
    public function accessRulesWork(
        ...
        parent::accessRulesWork(
            $I,
            $scenario,
            "//h2[contains(text(),'Root Usage by Sura')]"
        );
    }
}
