...
/**
 * Tests to ensure chart_grammatical.php works
 */
require_once 'tests/_support/QTChartPBCest.php';

class ChartGrammaticalPBCest extends QTPageCest
{
    use QTChartPBCest;

    public function _before($I, $scenario)
    {
        $this->page_of_interest = $I->getApplicationPage("chart_grammatical");
    ...
    {
        parent::accessRulesWork($I, $scenario, "//h2[contains(text(),'Grammatical Features by Sura')]");
    }
}
