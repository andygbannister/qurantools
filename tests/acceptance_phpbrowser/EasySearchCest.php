...
/**
 * Tests to ensure easy_search.php works
 */
class EasySearchCest extends QTPageCest
{
    public function _before($I, $scenario)
    {
        $this->page_of_interest = $I->getApplicationPage("easy_search");
