...
<html>
	<head>
		<?php
            ...
            window_title("Chart of Number of Different Verse Endings (Rhymes) per Sura");
        ?>
<?php
...
{
    $sort_field = "`DISTINCT_PATTERNS` DESC";
}
    ...
    var revenueChart = new FusionCharts({
        ...
        "dataSource":  {
          "chart": {
            ...
            "subCaption": "",
            "xAxisName": "Sura",
            "yAxisName": "Number of Different Verse Ending Patterns in Sura",
            "theme": "fint",
            "showValues": "0"
         },
       ...
       // if we are showing both Meccan and Medinan suras, we want two datasets and a legend
               ...
               for ($i = 0; $i < db_rowcount($result); $i++)
               {
                   ...
                   // data point
                   echo "\"value\": \"" . number_format($ROW["DISTINCT_PATTERNS"]) . "\",";
...
if ($miniMode)
{
    $expander_link = "../charts/chart_rhyme_number_of_patterns.php";
...
echo "  <h2>Number of Different Verse Endings (Rhymes) per Sura</h2>";
...
if (!$miniMode)
{
    ...
    echo "      <a href='chart_rhyme_number_of_patterns.php' class='$default_sort_selected'>";
    echo "        By Sura";
    echo "      </a>";
    echo "      <a href='chart_rhyme_number_of_patterns.php?SORT=1' class='$first_sort_option_selected'>";
    echo "        Number of Different Rhyme Patterns";
    echo "      </a>";
