...
<html>
	<head>
		<?php
            ...
            window_title("Penrice's Lexicon");
        ?>
	...
	{			
		...
		if (LoadPage > 176) {LoadPage = 176;}
		
		currentPage = LoadPage;
		
 		$("#PDFView").load("../ajax/ajax_pdf_load.php", {FOLDER:'/dictionary/Penrice', PREFIX:'Penrice_Page', PAGE:LoadPage});
	}
...
<main class='qt-site-content'>
    ...
    if ($LIGHTVIEW)
    {
        echo "<span style='float:right; margin-top:10px;' title='Open this PDF dictionary page in a new window'><a href='/dictionary/penrice.php?PAGE=$PAGE' target='_blank'><img src='../images/expand.png'></a></span>";
    }
    else
    {
        include "../library/menu.php";
